...
for approximation_mechanism in approximation_mechanisms:
    for parallelism in parallelisms: 
        ...
        output_folder = "../file/compiled_dec_" + approximation_mechanisms_acronym[approximation_mechanism] + "_" + format(parallelism) 
        ...
        for file in files:
            ...
            folder_out = "compiled_dec_" + approximation_mechanisms_acronym[approximation_mechanism] + "_" + format(parallelism) + "/"
