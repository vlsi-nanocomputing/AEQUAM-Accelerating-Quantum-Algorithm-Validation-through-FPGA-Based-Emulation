...
for file in files:
    ...
    start = time.time()
    ret = translator(filename_path,configuration_file_name,"compiled_dec/", parallelism,approximation_mechanism,False, True)
    stop = time.time()
    ...
    try:    
        ...
        output_filenamell = "../file/compiled_ll/" + file[:-5] + "_mapped_fixed_round_0_nearest.qasm"
