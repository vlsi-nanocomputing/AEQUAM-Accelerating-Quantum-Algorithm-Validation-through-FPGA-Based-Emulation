...
//They work with fixed point data representation considering nearest rounding technique
#include "emulator_fixed_nearest.h"
#include <iostream>
#include <fstream>
#include <string>
#include <math.h>
...
void execute_H (qstate &x, qstate &y){
    ...
    x.real =  (long long int)ceil(((float)INV_SQRT_2 * (float)( tmp_r + y.real ))/pow(2.0, frac));
    x.img =  (long long int)ceil(((float)INV_SQRT_2 * (float)( tmp_i + y.img ))/pow(2.0, frac));

    y.real =  (long long int)ceil(((float)INV_SQRT_2 * (float)( tmp_r - y.real ))/pow(2.0, frac));
    y.img = (long long int)ceil(((float)INV_SQRT_2 * (float)( tmp_i - y.img ))/pow(2.0, frac));    
...
void execute_T (qstate &y){
    ...
    y.real = (long long int)ceil(((float)INV_SQRT_2 * (float)( tmp - y.img ))/pow(2.0, frac));
    y.img = (long long int)ceil(((float)INV_SQRT_2 * (float)( tmp + y.img))/pow(2.0, frac));
...
void execute_TDG (qstate &y){
    ...
    y.real = (long long int)ceil(((float)INV_SQRT_2 * (float)( tmp + y.img ))/pow(2.0, frac));
    y.img = (long long int)ceil(((float)INV_SQRT_2 * (float)( y.img - tmp ))/pow(2.0, frac));
...
void execute_RX (qstate &x, qstate &y, gon &imm){
    ...
    x.real  = (long long int) ceil(((float)tmp_r * (float)imm.cos)/pow(2.0, frac)) + (long long int) ceil(((float)y.img * (float)imm.sin)/pow(2.0, frac));
    x.img = (long long int)ceil(((float)tmp_i * (float)imm.cos)/pow(2.0, frac)) - (long long int) ceil(((float)y.real * (float)imm.sin)/pow(2.0, frac));

    y.real = (long long int) ceil(((float)tmp_i * (float)imm.sin)/pow(2.0, frac)) + (long long int)ceil(((float)y.real * (float)imm.cos)/pow(2.0, frac));
    y.img = (long long int) ceil(((float)y.img * (float)imm.cos)/pow(2.0, frac)) - (long long int)ceil(((float)tmp_r * (float)imm.sin)/pow(2.0, frac));
...
void execute_RY (qstate &x, qstate &y, gon &imm){
    ...
    x.real = (long long int) ceil(((float)tmp_r * (float)imm.cos)/pow(2.0, frac)) - (long long int)ceil(((float)y.real * (float)imm.sin)/pow(2.0, frac));
    x.img = (long long int) ceil(((float)tmp_i * (float)imm.cos)/pow(2.0, frac)) - (long long int) ceil(((float)y.img * (float)imm.sin)/pow(2.0, frac));

    y.real = (long long int) ceil(((float)tmp_r * (float)imm.sin)/pow(2.0, frac)) + (long long int) ceil(((float)y.real * (float)imm.cos)/pow(2.0, frac));
    y.img = (long long int) ceil(((float)tmp_i * (float)imm.sin)/pow(2.0, frac)) + (long long int) ceil(((float)y.img * (float)imm.cos)/pow(2.0, frac));
}
...
void execute_RZ (qstate &x, qstate &y, gon &imm){
    ...
    x.real = (long long int) ceil(((float)tmp * (float)imm.cos)/pow(2.0, frac)) + (long long int) ceil(((float)x.img * (float)imm.sin)/pow(2.0, frac));
    x.img = (long long int) ceil(((float)x.img * (float)imm.cos)/pow(2.0, frac)) - (long long int) ceil(((float)tmp * (float)imm.sin)/pow(2.0, frac));

    tmp = y.real;

    y.real = (long long int)ceil(((float)tmp * (float)imm.cos)/pow(2.0, frac)) - (long long int) ceil(((float)y.img * (float)imm.sin)/pow(2.0, frac));
    y.img = (long long int)ceil(((float)tmp * (float)imm.sin)/pow(2.0, frac)) + (long long int) ceil(((float)y.img * (float)imm.cos)/pow(2.0, frac));
...
int emulatorVLSI_fixed_nearest(string istructionfilename, string sinecosinefilename, string outputfilename, int parallelism, bool verbose){
	...
	INV_SQRT_2 = (long long int)ceil(0.70710678118654752440084436210485*pow(2.0, (double)frac));
	...
	stateVector[0].real=1*(long long int)ceil(pow(2.0, (double) frac));
	stateVector[0].img=0;
